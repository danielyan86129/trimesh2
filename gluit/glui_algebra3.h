...
public:
    ...
    friend int operator!=(const vec2& a, const vec2& b);  // v1 != v2 ?
    // friend ostream& operator << (ostream& s, vec2& v);       // output to
    // stream friend istream& operator >> (istream& s, vec2& v);       // input
    // from strm.
...
public:
    ...
    friend int operator!=(const vec3& a, const vec3& b);  // v1 != v2 ?
    // friend ostream& operator << (ostream& s, vec3& v);       // output to
    // stream friend istream& operator >> (istream& s, vec3& v);       // input
    // from strm.
...
public:
    ...
    friend int operator!=(const vec4& a, const vec4& b);  // v1 != v2 ?
    // friend ostream& operator << (ostream& s, vec4& v);       // output to
    // stream friend istream& operator >> (istream& s, vec4& v);       // input
    // from strm.
...
public:
    ...
    friend int operator!=(const mat3& a, const mat3& b); // m1 != m2 ?
    // friend ostream& operator << (ostream& s, mat3& m);       // output to
    // stream friend istream& operator >> (istream& s, mat3& m);       // input
    // from strm.
...
public:
    ...
    friend int operator!=(const mat4& a, const mat4& b); // m1 != m2 ?
    // friend ostream& operator << (ostream& s, mat4& m);       // output to
    // stream friend istream& operator >> (istream& s, mat4& m);       // input
    // from strm.
    ...
    // friend vec4 operator * (const vec4& v, const mat4& a);       // linear
    // transform
    friend vec3 operator*(const mat4& a, const vec3& v); // linear transform
