...
static inline float radians(const float& x) { return M_PI_180f * x; }
...
static inline float degrees(const float& x) { return M_180_PIf * x; }
...
static inline float uniform_rnd() { return uniform_rnd(1.0f); }
...
static inline float normal_rnd() { return normal_rnd(1.0f); }
