...
public:
    ...
    unsigned make_shader(const char* name, const char* vert_text,
                         const char* frag_text);
    unsigned make_shader_from_files(const char* name, const char* vert_filename,
...
public:
    void attributearray1fv(int ind, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 1, p, stride, offset);
    }
    void attributearray2fv(int ind, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 2, p, stride, offset);
    }
    void attributearray3fv(int ind, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 3, p, stride, offset);
    }
    void attributearray4fv(int ind, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 4, p, stride, offset);
    }

    void attributearray1fv(const char* name, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray1fv(attribute(name, true), p, stride, offset);
    }
    void attributearray2fv(const char* name, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray2fv(attribute(name, true), p, stride, offset);
    }
    void attributearray3fv(const char* name, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray3fv(attribute(name, true), p, stride, offset);
    }
    void attributearray4fv(const char* name, const float* p, size_t stride = 0,
                           size_t offset = 0)
    {
    ...
    template <class T>
    void attributearray1fv(int ind, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray1fv(ind, (const float*)&v[0], stride, offset);
    }
    template <class T>
    void attributearray2fv(int ind, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray2fv(ind, (const float*)&v[0], stride, offset);
    }
    template <class T>
    void attributearray3fv(int ind, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray3fv(ind, (const float*)&v[0], stride, offset);
    }
    template <class T>
    void attributearray4fv(int ind, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
    ...
    template <class T>
    void attributearray1fv(const char* name, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray1fv(attribute(name, true), (const float*)&v[0], stride,
                          offset);
    }
    template <class T>
    void attributearray2fv(const char* name, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray2fv(attribute(name, true), (const float*)&v[0], stride,
                          offset);
    }
    template <class T>
    void attributearray3fv(const char* name, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray3fv(attribute(name, true), (const float*)&v[0], stride,
                          offset);
    }
    template <class T>
    void attributearray4fv(const char* name, const ::std::vector<T>& v,
                           size_t stride = 0, size_t offset = 0)
    {
        attributearray4fv(attribute(name, true), (const float*)&v[0], stride,
                          offset);
    }
...
public:
    void attributearray1fv(int ind, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 1, buf, stride, offset);
    }
    void attributearray2fv(int ind, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 2, buf, stride, offset);
    }
    void attributearray3fv(int ind, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 3, buf, stride, offset);
    }
    void attributearray4fv(int ind, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray(ind, 4, buf, stride, offset);
    }

    void attributearray1fv(const char* name, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray1fv(attribute(name, true), buf, stride, offset);
    }
    void attributearray2fv(const char* name, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray2fv(attribute(name, true), buf, stride, offset);
    }
    void attributearray3fv(const char* name, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
        attributearray3fv(attribute(name, true), buf, stride, offset);
    }
    void attributearray4fv(const char* name, unsigned buf, size_t stride = 0,
                           size_t offset = 0)
    {
...
public:
    ...
    template <class T>
    void vertexarray3fv(const ::std::vector<T>& v, size_t stride = 0,
                        size_t offset = 0)
    {
        vertexarray3fv((const float*)&v[0], stride, offset);
    }
    template <class T>
    void normalarray3fv(const ::std::vector<T>& v, size_t stride = 0,
                        size_t offset = 0)
    {
        normalarray3fv((const float*)&v[0], stride, offset);
    }
    template <class T>
    void colorarray3fv(const ::std::vector<T>& v, size_t stride = 0,
                       size_t offset = 0)
    {
        colorarray3fv((const float*)&v[0], stride, offset);
    }
    template <class T>
    void colorarray4fv(const ::std::vector<T>& v, size_t stride = 0,
                       size_t offset = 0)
    {
        colorarray4fv((const float*)&v[0], stride, offset);
    }
    template <class T>
    void texcoordarray2fv(const ::std::vector<T>& v, size_t stride = 0,
                          size_t offset = 0)
    {
    ...
    {
        return make_ibuffer((const unsigned*)&v[0],
                            v.size() * sizeof(v[0]) / sizeof(unsigned));
    }
    ...
    {
        update_ibuffer(buf, (const unsigned*)&v[0],
                       v.size() * sizeof(v[0]) / sizeof(unsigned));
    }
...
public:
    ...
    template <class T>
    unsigned make_texture(int w, int h, const ::std::vector<T>& v,
                          unsigned format = 0x1907u, unsigned type = 0x1401u,
                          unsigned internalformat = 0)
    {
        return make_texture(w, h, (const void*)&v[0], format, type,
                            internalformat);
    }
    void update_texture(unsigned texind, int w, int h, const void* p,
                        ...
                        unsigned internalformat = 0);
    template <class T>
    void update_texture(unsigned texind, int w, int h,
                        const ::std::vector<T>& v, unsigned format = 0x1907u,
                        unsigned type = 0x1401u, unsigned internalformat = 0)
    {
        update_texture(texind, w, h, (const void*)&v[0], format, type,
                       internalformat);
    }
    ...
    template <class T>
    void draw_tstrips(const ::std::vector<T>& v, size_t start,
                      size_t nstripinds)
    {
