...
static inline bool we_are_big_endian() { return !we_are_little_endian(); }
...
#else
    *(unsigned short*)p = (((*(unsigned short*)p) & 0xff00u) >> 8) |
...
#else
    *(unsigned*)p = (((*(unsigned*)p) & 0xff000000u) >> 24) |
...
static inline void swap_short(short& x) { swap_16((unsigned char*)&x); }
...
static inline void swap_int(int& x) { swap_32((unsigned char*)&x); }

static inline void swap_unsigned(unsigned& x) { swap_32((unsigned char*)&x); }

static inline void swap_float(float& x) { swap_32((unsigned char*)&x); }

static inline void swap_double(double& x) { swap_64((unsigned char*)&x); }
