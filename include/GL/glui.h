...
public:
    ...
    GLUI_Node(void)
    {
        parent_node = child_head = child_tail = next_sibling = prev_sibling =
            NULL;
    };
...
public:
    ...
    void draw_box(int x_min, int x_max, int y_min, int y_max, float r, float g,
                  float b);
    ...
    void get_this_column_dims(int* col_x, int* col_y, int* col_w, int* col_h,
...
public:
    ...
    GLUI_Listbox* add_listbox_to_panel(GLUI_Panel* panel, const char* name,
                                       int* live_var = NULL, int id = -1,
                                       GLUI_Update_CB callback = NULL);

    GLUI_Rotation* add_rotation(const char* name, float* live_var = NULL,
                                int id = -1, GLUI_Update_CB callback = NULL);
    GLUI_Rotation* add_rotation_to_panel(GLUI_Panel* panel, const char* name,
                                         float* live_var = NULL, int id = -1,
                                         GLUI_Update_CB callback = NULL);
    GLUI_Slider* add_slider(const char* name, int data_type = GLUI_SLIDER_INT,
                            float limit_lo = GLUI_SLIDER_LO,
                            float limit_hi = GLUI_SLIDER_HI, void* data = NULL,
                            int id = -1, GLUI_Update_CB callback = NULL);
    GLUI_Slider* add_slider_to_panel(GLUI_Panel* panel, const char* name,
                                     ...
                                     void* data = NULL, int id = -1,
                                     GLUI_Update_CB callback = NULL);

    GLUI_Translation* add_translation(const char* name, int trans_type,
                                      float* live_var = NULL, int id = -1,
                                      GLUI_Update_CB callback = NULL);
    GLUI_Translation* add_translation_to_panel(GLUI_Panel* panel,
                                               const char* name, int trans_type,
                                               float* live_var = NULL,
                                               int id = -1,
                                               GLUI_Update_CB callback = NULL);

    GLUI_Checkbox* add_checkbox(const char* name, int* live_var = NULL,
                                int id = -1, GLUI_Update_CB callback = NULL);
    ...
    GLUI_StaticText* add_statictext_to_panel(GLUI_Panel* panel,
                                             const char* name);
    ...
    GLUI_Spinner* add_spinner(const char* name,
                              ...
                              void* live_var = NULL, int id = -1,
                              GLUI_Update_CB callback = NULL);
    GLUI_Spinner* add_spinner_to_panel(GLUI_Panel* panel, const char* name,
                                       int data_type = GLUI_SPINNER_INT,
                                       void* live_var = NULL, int id = -1,
                                       GLUI_Update_CB callback = NULL);
